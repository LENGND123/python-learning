...
1.Python is sensitive to whitespace.

2.Ensure consistent indentation to avoid errors.

3.Ideally, use 4 spaces for indentation.

3. Statements:
1.Each line of code is a statement.
2.You can write multiple statements on one line using a semicolon (;), but this is not recommended.
